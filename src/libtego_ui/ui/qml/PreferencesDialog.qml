    ...
    TabView {
        ...
        style: TabViewStyle {
            ...
            tab: Rectangle {
                ...
                border.color: palette.midlight == "#323232" ? "#333333" : "#dddddd"
                border.width: 1
            }
            frame: Rectangle { color: palette.window; border.color: palette.midlight == "#323232" ? "#333333" : "#dddddd"; border.width: 1 }
