...
Rectangle{
    ...
    RowLayout {
        ...
        Button {
            ...
            height: 50
            onClicked: addContactWindowMain.close()
            ...
            Accessible.onPressAction: addContactWindowMain.close()
        }
        ...
        Button {
            ...
            onClicked: addContactWindowMain.accept()
