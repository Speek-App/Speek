...
ApplicationWindow {
    ...
    RowLayout {
        ...
        Button {
            ...
            Accessible.description: qsTr("Dismiss the incoming contact request")
        }

        Button {
            //: Label for button which rejects a contact request and block the sending user when pressed
            text: qsTr("Reject and Block")
